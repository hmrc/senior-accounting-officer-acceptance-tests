...
object PreviousSaoEndDatePage
  ...
  override val pageTitle: String =
    "What date did the previous SAO responsibility stop? - Submit a notification - Senior Accounting Officer notification and certificate - GOV.UK"
