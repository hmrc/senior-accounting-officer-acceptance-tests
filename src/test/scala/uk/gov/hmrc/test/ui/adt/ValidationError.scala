...
enum ValidationError(val errorMessage: String) {
  ...
  case NoElementChosenContactError  extends ValidationError("Select yes if you have added all the contacts you need")
  ...
  case SAOStandInSubmitterNameEmpty extends ValidationError("Enter your full name")
  case SAOStandInSubmitterAuthorisedByNameEmpty
      extends ValidationError("Enter the name of the SAO who authorised you to submit the certificate")
  case SAOStandInSubmitterNameTooLongError extends ValidationError("Your name must be 105 characters or less")
  case InvalidSAONameCharactersError       extends ValidationError("Name of the SAO must not include <, > or \"")
  case SAOStandInSubmitterNameInvalid      extends ValidationError("Your name must not include <, > or \"")
