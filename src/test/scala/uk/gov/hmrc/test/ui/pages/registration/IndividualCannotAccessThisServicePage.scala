...
object IndividualCannotAccessThisServicePage extends CommonPage {
  val pageUrl: String =
    s"${TestConfiguration.url("senior-accounting-officer-registration-frontend")}/cannot-access-service"
  ...
  val governmentGatewayOrganisationSignIn: By =
    By.linkText("sign in to Government Gateway with an organisation account")
